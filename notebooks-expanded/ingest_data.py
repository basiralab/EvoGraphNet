...
# MAGIC %sql 
# MAGIC CREATE SCHEMA IF NOT EXISTS xomics_mri.extended

# COMMAND ----------

# MAGIC %sql DROP TABLE IF NOT EXISTS xomics_mri.extended.mri_bronze

# COMMAND ----------

# MAGIC %sql 
# MAGIC CREATE TABLE xomics_mri.extended.mri_bronze (
...
# MAGIC %sql -- DROP TABLE IF NOT EXISTS xomics_mri.extended.mri_bronze_ext

# COMMAND ----------

# MAGIC %sql DESCRIBE DETAIL xomics_mri.extended.mri_bronze

# COMMAND ----------

# MAGIC %sql -- ALTER TABLE xomics_mri.extended.mri_bronze ADD COLUMNS (annotations STRING)
...
df = spark.read.text("/ml/blogs/gan/dpm_xl/evographnet/data-extended/*.txt")
...
# DBTITLE 0,e
df_bronze.write.format("delta").saveAsTable("xomics_mri.extended.mri_bronze_ext")

# COMMAND ----------

# MAGIC %sql SELECT * FROM xomics_mri.extended.mri_bronze_ext
...
# MAGIC %sql 
# MAGIC ANALYZE TABLE xomics_mri.extended.mri_bronze_ext COMPUTE STATISTICS

# COMMAND ----------

# MAGIC %sql
# MAGIC OPTIMIZE xomics_mri.extended.mri_bronze_ext
...
# MAGIC %sql 
# MAGIC SELECT * FROM xomics_mri.extended.mri_bronze_ext

# COMMAND ----------

# MAGIC %sql 
# MAGIC OPTIMIZE xomics_mri.extended.mri_bronze_ext ZORDER BY (id, description)
